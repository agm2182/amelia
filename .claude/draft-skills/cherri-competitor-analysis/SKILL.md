...
Save to: `competitors/ranking-comparison-YYYY-MM-DD.csv`
...
Save to: `competitors/content-gap-YYYY-MM-DD.csv`
...
Save to: `competitors/backlink-analysis-YYYY-MM-DD.csv`
...
Save to: `competitors/serp-features-YYYY-MM-DD.csv`
...
Full report saved to: `competitors/competitive-report-YYYY-Q#.md`
Supporting data: `competitors/competitive-report-YYYY-Q#-data/`
